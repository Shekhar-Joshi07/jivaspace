    ...
    <section className="section-spacing">
      <div className="section-container">
        <div className="relative overflow-hidden rounded-3xl shadow-2xl">
          ...
          <div className="relative z-10 px-6 py-16 text-center text-white sm:px-10 sm:py-20">
            <p className="text-sm uppercase tracking-[0.35em] text-primary-300 mb-4">
              Our Vision &amp; Mission
            </p>
            <div className="mx-auto h-[2px] w-16 bg-primary-500 mb-6" />
            <p
              className="mx-auto mb-6 max-w-3xl text-base leading-relaxed text-white sm:text-lg"
            ...
            <p
              className="mx-auto max-w-3xl text-base leading-relaxed text-white sm:text-lg"
              style={{ textShadow: '0 8px 24px rgba(0, 0, 0, 0.45)' }}
            >
